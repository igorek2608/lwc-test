({
    ...
    subscribe: function (component, event, helper) {
      ...
      console.log('Helper 1 - emp Api= ' + empApi);
      // Get the channel from the attribute.
      const channel = component.get('v.channel');
      console.log('Helper 2 - channel = ' + channel);
    ...
    onReceiveNotification: function (component, message) {
      ...
      const newNotification = {
        ...
        message: 'New Case ' + message.data.payload.Case_Number__c + ' is available.',
        caseNumber: message.data.payload.Case_Number__c,
        caseId: message.data.payload.Case_Id__c
      };
